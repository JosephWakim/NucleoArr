"""Run nucleosome simulations varying the chemical potential of the system.

Usage: python vary_chain_length.py CP
where CP is the chemical potential of the system.
